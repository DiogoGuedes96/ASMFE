...
export default function ScheduleHistoryListComponent({ data, compliment }: PropsDetails) {
    ...
    useEffect(() => {
        if (data && Object.keys(data).length > 0) {
            ...
            setPatientScheduleHistory(dynamicArray);
        }
    }, [data]);

    return (
        <>
            <Collapse className="collapse-box" items={patientScheduleHistory} />
        </>
    )
}