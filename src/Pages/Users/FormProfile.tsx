...
import { create, getById, getModulePermissions, syncPermissions, update } from "../../services/profiles.service";
...
export default function FormProfilePage(props: any) {
    ...
    const settings = {
        ...
        profiles_privileges: { title: 'Lista de perfis' }
    };
    ...
    const sections = [
        ...
        },
        {
            ...
            permissions: ['asm_schedule-asm_schedule', 'asm_schedule-asm_schedule_feedback', 'asm_schedule-asm_schedule_canceled']
        },
        {
            label: 'Central Telefónica',
            icon: <TableOutlined className="icon-permissions" />,
            permissions: ['calls-calls']
        },
        {
            label: 'Gerir Utentes',
    ...
    return (
        <>
            ...
            <Card
                ...
                <ConfirmModal
                    open={leaveThePage}
                    title="Tem a certeza que deseja sair sem gravar as alterações?"
